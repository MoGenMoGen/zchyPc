    ...
    methods:{
      ...
      changeDevice() {
        ...
        if(!isPC){
          ...
          if(window.location.pathname==='/sinovat2/tradeInfo/infoDetail'){  //新闻详情
            let id = this.until.getQueryString('id')
            window.location.href = window.location.origin+'/mob/views/tradeInfo/infoDetail.html?id='+id
          }
          if(window.location.pathname==='/sinovat2/shipDisplay/shipCat'){  // 船舶展示
            window.location.href = window.location.origin+'/mob/views/shipMan/shipShow.html'
          }
          if(window.location.pathname==='/sinovat2/shipDisplay/shipShow'){  //船舶展示——分类
          ...
          if(window.location.pathname==='/sinovat2/shipDisplay/showDetail'){  //船舶方案详情
            let id = this.until.getQueryString('id')
            window.location.href = window.location.origin+'/mob/views/shipMan/shipDetail.htm?id='+id
          }
          if(window.location.pathname==='/sinovat2/Trade/productDetail'){  //产品详情
            let type = this.until.getQueryString('type')
            let id = this.until.getQueryString('id')
            window.location.href = window.location.origin+'/mob/views/trading/shipDetail.html?id='+id
          }
          if(window.location.pathname==='/sinovat2/Trade/storeHome'){  //店铺首页
          ...
          if(window.location.pathname==='/sinovat2/pilotService/accessProduct'){  //试点服务——产品准入
            window.location.href = window.location.origin+'/mob/views/pilot/access.html'
          }
          if(window.location.pathname==='/sinovat2/pilotService/applyFor'){  //试点服务——补贴申请
            window.location.href = window.location.origin+'/mob/views/pilot/applyFor.html'
          }
          if(window.location.pathname==='/sinovat2/pilotService/onlineInquiry'){  //试点服务——补贴查询
            window.location.href = window.location.origin+'/mob/views/pilot/applyInfo.html'
          }
          if(window.location.pathname==='/sinovat2/pilotService/serviceInfo'){  //试点服务——信息公开、标准建设
            let id = this.until.getQueryString('id')
            window.location.href = window.location.origin+'/mob/views/pilot/list.html?id='+id
          }
          if(window.location.pathname==='/sinovat2/pilotService/infoDetail'){  //试点服务——信息公开、标准建设详情
          ...
          if(window.location.pathname==='/sinovat2/learning/fishery'){  //在线学习——视频学习、课件学习...
          ...
          if(window.location.pathname==='/sinovat2/learning/videoDetail'){  //直播详情
            let id = this.until.getQueryString('id')
            window.location.href = window.location.origin+'/mob/views/learning/detail.html?id='+id
          }
          if(window.location.pathname==='/sinovat2/learning/lessonDetail'){  //课件详情
            let id = this.until.getQueryString('id')
            let type = this.until.getQueryString('type')
            window.location.href = window.location.origin+'/mob/views/learning/liveDetail.html?id='+id+'&type='+type
          }
          if(window.location.pathname==='/sinovat2/learning/infoDetail'){  //法律法规、标准规范、文献资料详情
            let id = this.until.getQueryString('id')
            window.location.href = window.location.origin+'/mob/views/learning/referenceDetail.htm?id='+id
          }
          if(window.location.pathname==='/sinovat2/learning/video2'){  //视频
            let id = this.until.getQueryString('id')
            window.location.href = window.location.origin+'/mob/views/learning/lookLive.html?id='+id
          }
          if(window.location.pathname==='/sinovat2/learning/liveList'){  //在线学习——列表
            window.location.href = window.location.origin+'/mob/views/learning/index.html'
          }
          if(window.location.pathname==='/sinovat2/search/shipSearch'){  //搜索——船舶
