<template>
  <div id="footer" :style="{width:bWidth+'px'}">
      ...
      <div class="bottom main" :style="{width:width+'px'}">
        ...
        <a style="color: #999999" href="https://sinovat.oss-cn-shanghai.aliyuncs.com/c2abd41f294c4066a0de735361615849_ICPEDI%E8%AF%81%E4%B9%A6_01.jpg" target="_blank" class="cursor">增值业务经营许可证证书：浙B2-20210502</a>&nbsp;&nbsp;&nbsp;
