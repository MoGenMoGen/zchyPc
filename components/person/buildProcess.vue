      ...
      <div class="submitBox">
        ...
        <div class="content">
          ...
          <div>
            ...
            <p class="left-msg">
              <el-date-picker v-model="form.actDt" type="date" placeholder="选择日期时间">
              </el-date-picker>
            </p>
        ...
        <div v-for="(item,index) in list" :key="index">
          <div class="title">
            ...
            <p class="cont1">
              ...
              <span style="margin-right: 10px" v-if="item.audit==2">审核已通过</span>
              <span style="margin-right: 10px" v-else-if="item.audit==1">待审核</span>
              <span style="margin-right: 10px" v-else>未通过</span>
              <span @click.stop="change2(index)" style="margin-right: 10px" v-if="item.audit!=2"><i
                  class="el-icon-edit"></i>修改</span>
              <span @click.stop="delet2(index)" style="margin-right: 10px" v-if="item.audit!=2"><i
                  class="el-icon-delete"></i>删除</span>
              <!--              <span style="margin-right: 10px" v-if="item.audit==1">待审核</span>-->
        ...
        <div v-for="(item,index) in list" :key="index">
          <div class="title" @click="item.show=!item.show">
            ...
            <p>
              ...
              <span style="margin-right: 10px" v-else-if="item.audit==1">待审核</span>
              <span style="margin-right: 10px" v-else>未通过</span>
              <span @click.stop="change3(index)" style="margin-right: 10px" v-if="item.audit!=2"><i
                  class="el-icon-edit"></i>修改</span>
              <span @click.stop="delet2(index)" style="margin-right: 10px" v-if="item.audit!=2"><i
                  class="el-icon-delete"></i>删除</span>
              <span style="color: #2778BE;font-weight: bold">点击查看内容</span>
