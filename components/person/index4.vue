<template>
  <div class="left1">
    ...
    <div class="manage">
      <div class="title">
        <p><img src="@/assets/img/personal/首页/留言.png" alt=""/>检测船舶<span class="more" @click="toPage('./shipDetec')">查看更多<i class="el-icon-arrow-right"></i></span></p>
      </div>
      <div class="content1">
        <el-table
          :data="manageList"
...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      toDetail2(item,type){
        if(type=='1'){
          this.$router.push('./shipFileDetail?id='+item.id+"&cdType=3&formW=jiance&cdType2=3&shipCd="+item.cd+"&shipStatus="+item.statusNm)
        }else if(type=='2'){
