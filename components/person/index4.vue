<template>
  <div class="left1">
    ...
    <div class="message">
      <div class="title">
        <p>
          <img src="@/assets/img/personal/首页/云检验图标.png" alt="" />云检验<span class="more"
            @click="toPage('./allShipList')">查看更多<i class="el-icon-arrow-right"></i></span>
        </p>
      </div>
      <div class="content1">
        <el-table :data="yunCheckList" :cell-style="statusYun" style="width: 100%">
          <el-table-column prop="cd" width="150" label="船舶编号">
          </el-table-column>
          <el-table-column width="200" prop="nm" align="center" label="船舶名称" show-overflow-tooltip>
          </el-table-column>
          <el-table-column width="90" prop="cusname" align="center" label="客户名称">
          </el-table-column>
            ...
            <template slot-scope="scope">
              <div style="
                ...
                <div style="
                  ...
                  " class="btn_yunCheckDetail" @click="tofpxpert">
                  检验入口
                </div>
                <div style="color: rgb(39, 120, 190)" class="btn_yunCheckDetail" @click="
                    toPage(
    ...
    <div class="manage">
      <div class="title">
        <p>
          <img src="@/assets/img/personal/首页/整改单图标.png" alt="" />整改单<span class="more"
            @click="toPage('./rectification')">查看更多<i class="el-icon-arrow-right"></i></span>
        </p>
      </div>
      <div class="content1">
        <el-table :data="rectifyList" :cell-style="status" style="width: 100%" @row-click="toRectifydetail">
          ...
          <el-table-column prop="status" fixed="right" width="110" align="center" label="当前状态">
            <template slot-scope="scope">
              <div v-if="scope.row.state == 2" style="color: #ff3c00; border: 1px solid #ff3c00">
                待执行
              </div>
              <div v-else-if="scope.row.state == 3" style="color: #2778be; border: 1px solid #2778be">
                待结案
              </div>
    ...
    <div class="manage">
      <div class="title">
        <p>
          <img src="@/assets/img/personal/首页/投标管理.png" alt="" />投标管理<span class="more"
            @click="toPage('./tender?cdType=1')">查看更多<i class="el-icon-arrow-right"></i></span>
        </p>
      </div>
      <div class="content1">
        <el-table :data="bidList" style="width: 100%">
          ...
          <el-table-column width="110" align="center" label="状态">
            <template slot-scope="scope">
              ...
              <p v-else-if="returnDate(1, scope.row.bidOpenTm)" style="color: #2778be">
                评标中
              </p>
              <p v-else-if="returnDate(2, scope.row.bidEndTm)" style="color: #3fab2e">
                投标中
              </p>
          ...
          <el-table-column align="center" width="110" fixed="right" prop="operations" label="操作">
            <div class="btnList" slot-scope="scope">
              ...
              <p
                v-if="scope.row.signin.shipBidSigninVo.signinStatus==1&&!scope.row.bidDecideTm&&returnDate(1,scope.row.bidOpenTm)">
                已签到</p>
    ...
    <div class="manage">
      <div class="title">
        <p>
          <img src="@/assets/img/personal/首页/留言.png" alt="" />检测船舶<span class="more"
            @click="toPage('./shipDetec')">查看更多<i class="el-icon-arrow-right"></i></span>
        </p>
      </div>
      <div class="content1">
        <el-table :data="manageList" style="width: 100%">
          ...
          <el-table-column width="100" prop="productName" align="center" label="客户名称">
          </el-table-column>
          <el-table-column prop="statusNm" width="85" align="center" label="船舶状态">
          </el-table-column>
          <el-table-column align="center" width="90" fixed="right" prop="operations" label="操作">
            <template slot-scope="scope">
              <div class="btnList">
                <button class="button3" @click="toDetail2(scope.row, '1')" v-if="scope.row.statusNm != '已交船'">
                  新增
                </button>
