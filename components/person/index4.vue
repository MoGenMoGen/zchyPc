    ...
    <div class="manage">
      ...
      <div class="content1">
        ...
        >
          ...
          <el-table-column prop="nm" width="150" label="整改名称">
          </el-table-column>
          <el-table-column
            width="200"
            prop="rectifyDemand"
      ...
      <div class="title">
        <p>
          <img
            ...
            alt=""
          />投标管理<span class="more" @click="toPage('./tender?cdType=1')"
            >查看更多<i class="el-icon-arrow-right"></i
          ></span>
        </p>
      </div>
        ...
        <el-table :data="bidList" style="width: 100%">
          ...
          <el-table-column width="110" align="center" label="状态">
            <template slot-scope="scope">
              ...
              <p
                v-else-if="returnDate(1, scope.row.bidOpenTm)"
                style="color: #2778be"
              >
                评标中
              </p>
              <p
                v-else-if="returnDate(2, scope.row.bidEndTm)"
                style="color: #3fab2e"
              >
                投标中
              </p>
          ...
          >
            <div class="btnList" slot-scope="scope">
              ...
              <button
                class="button3"
                v-if="
                  (scope.row.depositStatus == 1 ||
                    scope.row.depositStatus == 3) &&
                  scope.row.signin.shipBidSigninVo.signinStatus == 0 &&
                  !scope.row.bidDecideTm &&
                  returnDate(1, scope.row.bidOpenTm)&&scope.row.despoit&&scope.row.despoit.shipBidDepositVo.audit==2
                "
              ...
              <p
                v-if="
                  (scope.row.depositStatus == 1 ||
                    scope.row.depositStatus == 3) &&
                  scope.row.signin.shipBidSigninVo.signinStatus == 1 &&
                  !scope.row.bidDecideTm &&
                  returnDate(1, scope.row.bidOpenTm)
                "
              >
                已签到
              </p>
