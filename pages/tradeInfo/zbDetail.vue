  ...
  <div id="home" :style="{width:bWidth + 'px'}">
    ...
    <div class="content main" :style="{width:width + 'px'}">
      ...
      <div class="partB" >
        ...
        <div class="body" v-html="cont">

        </div>
        <div class="bottom-btn" v-if="signFlag" @click="sign">报名</div>
      </div>
    </div>
    ...
    <el-dialog title="提示" :visible.sync="dialogVisible" width="30%">
      <span>当前帐号：{{currentRole.company}}[{{currentRole.identityNm}}]</span>
...
<script>
    ...
    export default {
      ...
      methods:{
        ...
        canSign() {
          this.api.getBidInfo(this.infoId).then(res => {
