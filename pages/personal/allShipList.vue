    ...
    <div class="main">
      ...
      <div v-if="dialogVisible" class="pop" >
        <div class="pop-cont">
          ...
          <div class="popMain">
             <div><p>联系人：</p><input v-model="form.linkman"/></div>
             <div><p>联系电话：</p><input v-model="form.phone" type="tel"/></div>
             <div><p>出售金额：</p><input v-model="form.salesAmt" type="number"/></div>
             <div><p>备注：</p><textarea v-model="form.rmks"></textarea></div>
          </div>
          <p>
      ...
      <div class="line4">
        <div v-for="item in list" :key="item.id">
          ...
          <p>
            ...
            <span v-if="item.statusCd=='DOCS_STATUS.03'" class="sail" @click="showPop(item)">我要出售</span>
            <!--船厂、设计院、监理监造、检验检测-->
            <span v-if="currentRole.identityCd=='identity30' || currentRole.identityCd=='identity20' || currentRole.identityCd=='identity50' || currentRole.identityCd=='identity40'" class="sail" @click="toNotice(item)">节点通知</span>
          </p>
