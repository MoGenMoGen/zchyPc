...
<div id="home" :style="{width: bWidth+'px'}">
  ...
  <div class="header main" :style="{width:width + 'px'}">
    <el-breadcrumb separator-class="el-icon-arrow-right" :style="{width:width+'px'}" class="bc main">
      ...
      <el-breadcrumb-item :to="{ path: './allDesign' }">设计院总览</el-breadcrumb-item>
      <el-breadcrumb-item ><p class="textRed">设计院详情</p></el-breadcrumb-item>
    </el-breadcrumb>
  </div>
  <!--内容-->
  <div class="body main" :style="{width:width + 'px'}">
    ...
    <div class="right">
      ...
      <button @click="designShow=true">设计预约</button>
    </div>
  </div>
  <!-- 内容-->
...
<script>
    ...
    export default {
      ...
      async mounted(){
        ...
        if(this.info.imgUrl){
          this.objectFitImages(this.$refs.info)
        }
        this.getShipList()
      },
      methods:{
