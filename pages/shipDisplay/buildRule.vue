<template>
  ...
  <div id="home" :style="{width:bWidth + 'px'}">
    <div class="header">
      <img :height="bannerHeight+'px'" class="adert" alt="" src="../../assets/img/shipDisplay/建造规范-大.png" :style="{width:bWidth + 'px'}"/>
...
<script>
    ...
    export default {
      ...
      async asyncData(context){
        ...
        // context.app.query.toW(qry2,'type',2,'EQ')
      ...
      methods:{
        ...
        toPage(item){
          let url = './ruleDetail?id='+item.id+"&cid="+item.cid
